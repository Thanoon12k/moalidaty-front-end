...
import 'package:moalidaty1/features/budgets/ui/subscriber_budgets_page.dart';
...
class BudgetsListPage extends StatelessWidget {
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon:
                        budget_service.searchQuery.value.isNotEmpty
                            ? IconButton(
  ...
  Widget _buildBudgetsList(context) {
    ...
    Map<int, List<Budget>> groupedBudgets =
        budget_service.getBudgetsGroupedByYear();

    List<int> sortedYears =
        groupedBudgets.keys.toList()..sort((a, b) => b.compareTo(a));
  ...
  void _showYearFilterDialog(BuildContext context) {
    final years =
        budget_service.BudgetList.map((b) => b.year).toSet().toList()
